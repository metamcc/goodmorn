...
func (setup *FabricSetup) Initialize() error {
	...
	// Creation of the channel mcc. A channel can be understood as a private network inside the main network between two or more specific network Organizations
...
func (setup *FabricSetup) InstallAndInstantiateCC() error {
	...
	// In this case, we set the rule to : Endorse the transaction if the transaction have been signed by a member from the org "org1.mycreditchain.io"
	ccPolicy := cauthdsl.SignedByAnyMember([]string{"org1.mycreditchain.io"})
