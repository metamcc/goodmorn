...
sed -i "s/  datasource: fabric-ca-server.db/  datasource: root:qawsedrf@tcp(rcamariadb-org1:3306)\/fabric_ca?parseTime=true/" $FABRIC_CA_SERVER_HOME/fabric-ca-server-config.yaml
