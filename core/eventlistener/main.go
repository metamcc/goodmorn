...
export FABRIC_CFG_PATH=/home/vagrant/workspace/go/src/github.com/mycreditchain/configurations/network-setting/ca-server/fixtures/
...
//	"fmt"
	...
	"github.com/mycreditchain/eventlistener/setup"
)
...
//	flag.StringVar(&defaultConfig,"config", "fingerCloud", "컨피그 옵션 지정")
//	flag.Parse()
//	fmt.Println("config =",defaultConfig )
	os.Setenv("FABRIC_CFG_PATH", os.Getenv("HOME")+eventclient.PATH_PREFIX+"/go/src/github.com/mycreditchain/configurations/network-setting/ca-server/fixtures/")
	setup.ReadCLInputs()
